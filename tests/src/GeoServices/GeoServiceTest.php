...
//        $this->object->lookup('185.10.22.56');
    ...
    /**
     * After wrong db file -> maxmind should be disabled
     */
    public function testMaxmindDbWrongFile() {
        $this->object->setMaxmindDb('');
        $this->assertEquals(false, $this->object->maxmind, "Maxmind is disabled after invalid file is set");
    }

    /**
     * After wrong db file -> maxmindOld should be disabled
     *
     */
    public function testMaxmindOldDbWrongFile() {
        $this->object->setMaxmindOldDb('');
        $this->assertEquals(false, $this->object->maxmindold, "Maxmind old is disabled after invalid file is set");
    }
